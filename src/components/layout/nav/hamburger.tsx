...
import { HamburgerBackdrop } from "./hamburger-backdrop"
...
export const Hamburger = () => {
  ...
  return (
    <>
      <HamburgerBackdrop isOpen={isOpen} onClose={toggle} />
          ...
          {isOpen && (
            <m.nav
              ...
              className="
                ...
                font-bold tracking-tighter overflow-y-auto
              "
            >
